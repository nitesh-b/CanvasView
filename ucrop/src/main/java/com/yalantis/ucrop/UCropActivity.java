...
public class UCropActivity extends AppCompatActivity {
    ...
    @IntDef({NONE, SCALE, ROTATE, DRAW, ALL})
    ...
    private ViewGroup mWrapperStateAspectRatio, mWrapperStateRotate, mWrapperStateScale, mWrapperStateDraw;
    private ViewGroup mLayoutAspectRatio, mLayoutRotate, mLayoutScale, mLayoutDraw;
    ...
    private int[] mAllowedGestures = new int[]{SCALE, ROTATE, DRAW, ALL};
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        if (mShowBottomControls) {
            ...
            mWrapperStateDraw = findViewById(R.id.state_draw);
            mWrapperStateDraw.setOnClickListener(mDrawClickListener);
            ...
            mLayoutDraw =  findViewById(R.id.layout_draw_wheel);
    ...
    private void setWidgetState(@IdRes int stateViewId) {
        ...
        mWrapperStateDraw.setSelected(stateViewId == R.id.state_draw);

        mLayoutAspectRatio.setVisibility(stateViewId == R.id.state_aspect_ratio ? View.VISIBLE : View.GONE);
        mLayoutRotate.setVisibility(stateViewId == R.id.state_rotate ? View.VISIBLE : View.GONE);
        mLayoutScale.setVisibility(stateViewId == R.id.state_scale ? View.VISIBLE : View.GONE);
        mLayoutDraw.setVisibility(stateViewId == R.id.state_draw ? View.VISIBLE : View.GONE);
        ...
        }else if (stateViewId == R.id.state_draw){
    ...
    private void changeSelectedTab(int stateViewId) {
        ...
        mWrapperStateDraw.findViewById(R.id.text_view_draw).setVisibility(stateViewId == R.id.state_draw ? View.VISIBLE : View.GONE);
    ...
    private void setAllowedGestures(int tab) {
        mUCropView.showOverLayView(tab != 2);
//        if(drawn){
//            try {
//                cropAndLoad();
//            } catch (Exception ex){
//                Log.d(TAG, "setAllowedGestures: error wile crop and load");
//            }
//
//        }
        ...
        mGestureCropImageView.setDrawEnable(mAllowedGestures[tab] == ALL || mAllowedGestures[tab] == DRAW);
    }
    ...
    private void cropAndLoad() {
        ...
        mGestureCropImageView.cropAndSaveImage(mCompressFormat, mCompressQuality, new BitmapCropCallback() {
            ...
            public void onBitmapCropped(@NonNull Uri resultUri, int offsetX, int offsetY, int imageWidth, int imageHeight) {
                ...
                intent.putExtra(UCrop.EXTRA_INPUT_URI, resultUri);
                setImageData(intent);
